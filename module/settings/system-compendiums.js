...
export class SystemCompendiums extends FormApplication {
  ...
  static get defaultOptions() {
    ...
    mergeObject(options, {
      ...
      template: "systems/ctm/templates/settings/system-compendiums.html",
      height: 'fit-content',
      width: 600,
      minimizable: false,
      closeOnSubmit: true,
...
export class SystemCompendiumTable {
  ...
  async $chatRolledResult(row) {
    ...
    const flavorContent = await renderTemplate('systems/ctm/templates/chat-compendium-table-roll.html', {
      roll: row.roll,
  ...
  async $chatSystemCompendiumTable(table, typeName) {
    const flavorContent = await renderTemplate('systems/ctm/templates/chat-compendium-table.html', {
